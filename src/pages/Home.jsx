        ...
        <div> 
           ...
           <div className="bg-pure-greys-5 text-richblack-700">
                ...
                <div className="homepage_bg h-[310px]">
                    <div className="w-11/12 max-w-maxContent flex flex-col items-center jusitfy-center gap-5 mx-auto">
                ...
                <div className=' w-11/12 max-w-maxContent flex flex-col items-center jusitfy-between gap-5 mx-auto'>
